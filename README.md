...
* Score: 5.7 (6.7 for the whole course)
* Contribution (group of 3): most of the coding work and as the team leader 
...
* Read the lecture book and summarized the ideas, and made the presentation
* Score: 8 ( 8 for the whole  course)
...
* Implemented priority queue for scheduling, using a mutex for concurrency control, RPC for communicating
* Score:3600/6000 (10 for the whole course)
* Contribution (group of 4): implemented a part of components
...
* Extended pipeline for relation extraction based on handwritten patterns
* Score: 9 (8 for the whole course)
* Contribution (group of 4): built up the main pipeline and implemented most of the functions
...
* Score: 8.5 (8.5 for the whole course)
...
Many homework, I had a bad feeling about this course. It proves that maths is boring for me.
...
Contribution (group of 3): worked on part of feature engineering and established most of the models 

Github Repo: [https://github.com/AdolphusEnvy/data_mining_course](https://github.com/AdolphusEnvy/data_mining_course)

The score for the whole course: 8.5
...
Learning virtualization on lightweight and orchestration of containers
* Deployed URL-shortener on a single container and tested communication between containers
* Deployed URL-shortener on multi nodes organized by Kubernetes
* Score: 7.5
...
The score for the whole course: 7.5
...
* Used random-forest model for recognition
* Score:8.7 ( 8 for the whole course)
